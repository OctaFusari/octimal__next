      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            >
              Human Factors Engineering and UX/UI Design for complex, high-impact systems.
              Trentino → World.
            </p>
            {/* Social dots */}
          ...
          <motion.div variants={fadeUp}>
            ...
            >
              UX tips, case studies and insights on complex systems every two weeks.
            </p>
            <div
              style={{
                display: 'flex',
        ...
        >
          ...
          >
            © {new Date().getFullYear()} OCTIMAL - Trento, Italy
          </p>
          ...
          <p style={{ fontFamily: 'var(--font-outfit)', fontSize: '0.75rem', color: '#6B6B65' }}>
            If you're reading this we'll offer you a coffee at our first meeting{' '}
